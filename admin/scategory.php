...
<li class="panel">
                ...
                <div class="row" id="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                              <button type="submit" onclick="addsubcat();" class="btn btn-success"><i class="icon-plus"></i>&nbsp;Add New SubCategory</button>
</div>
                <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
 ...
 <?php
        ...
        <td width=100 style='padding-left:20px'> 
         <button type='button' onclick='loadsedit(".$row[0].");' class='btn btn-primary btn-sm'><i class=icon-pencil icon-white></i></button>
             
       <a href=sdelete.php?subcat_id=".$row[0]." title=Delete style='color:white' class='btn btn-danger btn-sm'><i class=icon-trash icon-white></i></a></td>
              </tr>";
}
?>
</form>
