        ...
        <div id="content">
            ...
            <div class="inner">
                  ...
                  <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                                <button type="submit" onclick="addbanner();" class="btn btn-success" value="insert"><i class="icon-plus"></i>&nbsp;Add New banner</button>
</div><br>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <!-- <a href="sinsert.php" class="btn btn-primary">Add Sub Category</a>-->
                        </div>
             ...
             while($row=mysqli_fetch_row($rs))
              {
                ...
                $x=strstr($row[3],"upload");
                echo "<tr>
                      
                      <td>".$row[0]."</td>
                      <td>".$row[1]."</td>
                      <td>".$row[2]."</td>
                      <td><img src=".$x." height=50 width=50></td>
                
        <td width=100> 

         <button type='button' onclick='loadbanneredit(".$row[0].");' class='btn btn-primary btn-sm'><i class=icon-pencil icon-white></i></button>
             
       <a href=bannerdelete.php?banner_id=".$row[0]." title=Delete style='color:white' class='btn btn-danger btn-sm'><i class=icon-trash icon-white></i></a></td>
              </tr>";
}
?>
    </form>
