...
<li class="panel active">
               ...
               <li class="panel ">
                ...
                <li class="panel ">
                    <a href="order.php" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <button type="submit" onclick="addproducts();" class="btn btn-success"><i class="icon-plus"></i>&nbsp;Add New Product</button>
                        </div>
             ...
             while($row=mysqli_fetch_row($rs))
              {
                ...
                echo "<tr>
                      ...
                      <td><img src=".$x." height=60 width=60></td>
                
        <td width=100 style='padding-left=20px'> 

         <button type='button' onclick='loadpedit(".$row[0].");' class='btn btn-primary btn-sm'><i class=icon-pencil icon-white></i></button>
             
       <a href=pdelete.php?p_id=".$row[0]." title=Delete style='color:white' class='btn btn-danger btn-sm'><i class=icon-trash icon-white></i></a></td>
              </tr>";
}
?>
