               ...
               <li class="panel ">
                ...
                <li class="panel ">
                    <a href="cpassword.php" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav">
                        <i class="icon-tasks"> </i> Change Password 
                ...
                <li class="panel ">
                    <a href="manageuser.php" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav">
                        <i class="icon-tasks"> </i> Manage User 
                ...
                <li class="panel ">
                    <a href="login.php" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <thead>
                                        <tr>
                                            <th><input type="submit" name="save" value="save" align="center">
                                             </th>
                                        </tr>
                                    </thead>
...

{
    ...
    $q = " INSERT INTO subcategory VALUES ('$subcat_id', '$subcat_name', '$p')";
