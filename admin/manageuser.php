...
</table><form action="manageuser.php" method="post">
                            <table class="table table-striped table-bordered table-hover" >
                            <tr>
                <th width="136" scope="col">UserId</th>
                <th width="102" scope="col">FirstName</th>
                <th width="109" scope="col">Email</th>
                <th width="129" scope="col">Contact_no</th>
                <th width="129" scope="col">Password</th>
                <th width="129" scope="col">Gender</th>
                <th width="129" scope="col">Registration Date</th>
                                        </tr>
                                          </thead>
                               <tbody>
                                <?php
